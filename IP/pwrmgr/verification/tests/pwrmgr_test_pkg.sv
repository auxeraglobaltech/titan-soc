...
//
// pwrmgr -- compile-check test package.
//
// One test, and it checks nothing. Its only job is to prove the UVM phasing
// runs to completion on top of an elaborated pwrmgr DUT.
//
...
package pwrmgr_test_pkg;
  ...
  class pwrmgr_base_test extends uvm_test;
    ...
    function new(string name = "pwrmgr_base_test", uvm_component parent = null);
