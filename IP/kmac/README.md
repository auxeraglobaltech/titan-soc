...
| | |
|---|---|
| **Tier** | advanced/security — Keccak core with masking and an app interface |
| **Source** | `vendor/opentitan/hw/ip/kmac/` @ `365c167e` |
| **Top module** | `kmac` (`rtl/kmac.sv`) |
| **RTL files** | 25 (including 9 externally-owned packages) |
| **DUT ports** | 20 |
| **Bus** | TL-UL device |
| **Interrupts** | 3 |
...
| Interrupts | `intr_kmac_done_o`, `intr_fifo_empty_o`, `intr_kmac_err_o` |
| Alerts | yes |
| RACL | — none |
...
| [`docs/kmac.hjson`](docs/kmac.hjson) | Machine-readable register description — **generate your RAL from this** |
| [`docs/application-interface.svg`](docs/application-interface.svg) | Diagram |
| [`docs/keccak-round.svg`](docs/keccak-round.svg) | Diagram |
| [`docs/kmac-block-diagram.svg`](docs/kmac-block-diagram.svg) | Diagram |
| [`docs/kmac-padding.svg`](docs/kmac-padding.svg) | Diagram |
| [`docs/sha3-padding-fsm.svg`](docs/sha3-padding-fsm.svg) | Diagram |
| [`docs/sha3-padding.svg`](docs/sha3-padding.svg) | Diagram |

Online: https://opentitan.org/book/hw/ip/kmac/
