...
//
// spi_host -- compile-check test package.
//
// One test, and it checks nothing. Its only job is to prove the UVM phasing
// runs to completion on top of an elaborated spi_host DUT.
//
...
package spi_host_test_pkg;
  ...
  class spi_host_base_test extends uvm_test;
    ...
    function new(string name = "spi_host_base_test", uvm_component parent = null);
