...
//
// uart -- compile-check test package.
//
// One test, and it checks nothing. Its only job is to prove the UVM phasing
// runs to completion on top of an elaborated uart DUT.
//
...
package uart_test_pkg;
  ...
  class uart_base_test extends uvm_test;
    ...
    task run_phase(uvm_phase phase);
      ...
      // Let the DUT sit idle for a while. Nothing is driven and nothing is
      // checked -- reaching the end without an elaboration or phasing error
      // is the entire pass criterion.
